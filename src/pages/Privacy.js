...
const Privacy = (props) => {
  return (
    <section className={classes.sectionPrivacy}>
      <>
        <style
              ...
              <strong>
                <span style={{ fontSize: 15 }}>
                  <span data-custom-class="subtitle">
                    Last updated <bdt className="question">March 13, 2023</bdt>
                  </span>
                </span>
              </strong>
            </span>
            ...
            <div style={{ lineHeight: "1.5" }}>
              <span style={{ fontSize: 15 }}>
                <span data-custom-class="body_text">
                  ...
                  <bdt className="block-component" />
                  <bdt className="question">Genhant</bdt>
            ...
            <div style={{ lineHeight: "1.5" }}>
              <span style={{ fontSize: 15 }}>
                <span data-custom-class="body_text">
                  ...
                  here: <bdt className="question">GetOData.com/support</bdt>
                                                    ...
                                                    >
                                                      ...
                                                      >
                                                        <span data-custom-class="body_text">
                                                          ...
                                                          <bdt className="statement-end-if-in-editor" />{" "}
                                                          apart from us. They
                                                          also commit to protect
                                                          the data they hold on
                                                          our behalf and to
                                                          retain it for the
                                                          period we instruct.{" "}
                                                          <bdt className="statement-end-if-in-editor" />
