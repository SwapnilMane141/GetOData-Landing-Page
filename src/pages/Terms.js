...
const Terms = (props) => {
  return (
    <section className={classes.sectionTerms}>
        ...
        <div align="center" style={{ textAlign: "left" }}>
          ...
          >
            ...
            >
              ...
              <bdt className="question">
                <a
                  href="http://www.GetOData.com"
                  target="_blank"
                  data-custom-class="link"
                >
                  http://www.GetOData.com
                </a>
              </bdt>{" "}
          ...
          >
            ...
            >
              ...
              email at <bdt className="question">support@tromdoro.com</bdt>
              <bdt className="block-component" />,
              <bdt className="statement-end-if-in-editor" /> or by mail to{" "}
              <bdt className="question">NRB Placia</bdt>
              <bdt className="block-component" />,{" "}
              <bdt className="question">Aurangabad</bdt>
              <bdt className="block-component" />,{" "}
              <bdt className="question">Maharashtra</bdt>
              <bdt className="statement-end-if-in-editor" />
              <bdt className="block-component" />{" "}
              <bdt className="question">431005</bdt>
              <bdt className="statement-end-if-in-editor" />
              <bdt className="block-component">
                <bdt className="block-component">,&nbsp;</bdt>
          ...
          >
            ...
            >
              ...
              <bdt className="statement-end-if-in-editor" />
              ), and <bdt className="question">Genhant</bdt>, concerning your
        ...
        <div align="center" style={{ textAlign: "left" }}>
          ...
          >
            ...
            >
              ...
              <bdt className="question">contact@swapnilmane.com</bdt>. If we
        ...
        <div align="center" style={{ textAlign: "left" }}>
          ...
          >
            <span style={{ fontSize: 15 }}>
              ...
              <bdt className="question">contact@swapnilmane.com</bdt>
              <bdt className="block-component" /> or call us at{" "}
              <bdt className="question">9767259450</bdt>
              <bdt className="statement-end-if-in-editor" />.
              <bdt className="statement-end-if-in-editor" />
            </span>
          </div>
          ...
          >
            ...
            >
              ...
              <strong>
                ...
                >
                  <a
                    href="https://www.GetOData.com/privacy"
                    target="_blank"
                    data-custom-class="link"
                  >
                    https://www.GetOData.com/privacy
                  </a>
                </bdt>
              </strong>
          ...
          >
            ...
            >
              ...
              . <bdt className="question">Genhant</bdt> and yourself irrevocably
          ...
          >
            ...
            arbitrators shall be <bdt className="question">one (1)</bdt>. The
            seat, or legal place, or arbitration shall be{" "}
            <bdt className="block-component" />
            <bdt className="question">Pune</bdt>,{" "}
            <bdt className="block-component" />
            <bdt className="question">India</bdt>
            <bdt className="statement-end-if-in-editor" />
            <bdt className="else-block" />. The language of the proceedings
            shall be <bdt className="question">English</bdt>. The governing law
          ...
          >
            <strong>
              ...
              >
                <strong>
                  <bdt className="block-component" />
                  Phone: <bdt className="question">9767259450</bdt>
                  <bdt className="statement-end-if-in-editor" />
                </strong>
              </span>
            </strong>
